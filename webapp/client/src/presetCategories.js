export const CATEGORIES = [
  { key: 'nature', label: 'Nature', color: 'var(--cat-nature)', presets: ['nature_earth', 'golden_hour', 'forest_moody', 'dramatic_sky', 'dramatic_mono', 'autumn_glow', 'misty_morning', 'vibrant_bloom'] },
  ...
  { key: 'mood', label: 'Mood', color: 'var(--cat-mood)', presets: ['pastel_dream', 'punch_pop', 'cinematic_drama', 'vibrant_travel', 'analog_fade'] },
];
